...
Abstract type for [`Enzyme.autodiff`](@ref) function argument wrappers like
...
Mark a function argument `x` of [`Enzyme.autodiff`](@ref) as constant,
...
Mark a function argument `x` of [`Enzyme.autodiff`](@ref) as active,
...
Mark a function argument `x` of [`Enzyme.autodiff`](@ref) as duplicated, Enzyme will
