...
@testset "Simple tests" begin
    ...
    test_scalar(Base.FastMath.exp2_fast, 1.0)
    test_scalar(Base.FastMath.exp10_fast, 1.0)
    test_scalar(Base.Math.exp_fast, 1.0)
    test_scalar(Base.Math.exp2_fast, 1.0)
    test_scalar(Base.Math.exp10_fast, 1.0)
    test_scalar(Base.FastMath.exp2_fast, 1.0f0; rtol = 1.0e-5, atol = 1.0e-5)
    test_scalar(Base.FastMath.exp10_fast, 1.0f0; rtol = 1.0e-5, atol = 1.0e-5)
    test_scalar(Base.Math.exp_fast, 1.0f0; rtol = 1.0e-5, atol = 1.0e-5)
    test_scalar(Base.Math.exp2_fast, 1.0f0; rtol = 1.0e-5, atol = 1.0e-5)
    test_scalar(Base.Math.exp10_fast, 1.0f0; rtol = 1.0e-5, atol = 1.0e-5)
