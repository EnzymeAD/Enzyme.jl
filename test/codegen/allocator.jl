...
# CHECK-NEXT:   %3 = call noalias nonnull dereferenceable(8) dereferenceable_or_null(8) {} addrspace(10)* @julia.gc_alloc_obj({}** %2, i64 8, {} addrspace(10)* addrspacecast ({}* inttoptr (i64 {{\d*}} to {}*) to {} addrspace(10)*))
