...
@testset "TypeTree" begin
    ...
    if Sys.WORD_SIZE == 64
        @test tt(UnionMember) == "{[0]:Float@float, [4]:Anything, [5]:Anything, [6]:Anything, [7]:Anything, [8]:Pointer, [16]:Integer, [17]:Anything, [18]:Anything, [19]:Anything, [20]:Anything, [21]:Anything, [22]:Anything, [23]:Anything}"
        ...
        @test tt(Sibling2{LList2{Float64}}) ==
              "{[0]:Pointer, [0,0]:Pointer, [0,8]:Float@double, [8]:Integer, [9]:Anything, [10]:Anything, [11]:Anything, [12]:Anything, [13]:Anything, [14]:Anything, [15]:Anything, [16]:Pointer, [16,0]:Pointer, [16,8]:Float@double}"
        ...
        @test tt(Sibling2{Sibling2{LList2{Tuple{Float32,Float64}}}}) ==
              "{[0]:Pointer, [0,0]:Pointer, [0,8]:Float@float, [0,12]:Anything, [0,13]:Anything, [0,14]:Anything, [0,15]:Anything, [0,16]:Float@double, [8]:Integer, [9]:Anything, [10]:Anything, [11]:Anything, [12]:Anything, [13]:Anything, [14]:Anything, [15]:Anything, [16]:Pointer, [16,0]:Pointer, [16,8]:Float@float, [16,12]:Anything, [16,13]:Anything, [16,14]:Anything, [16,15]:Anything, [16,16]:Float@double, [24]:Integer, [25]:Anything, [26]:Anything, [27]:Anything, [28]:Anything, [29]:Anything, [30]:Anything, [31]:Anything, [32]:Pointer, [32,0]:Pointer, [32,8]:Float@float, [32,12]:Anything, [32,13]:Anything, [32,14]:Anything, [32,15]:Anything, [32,16]:Float@double, [40]:Integer, [41]:Anything, [42]:Anything, [43]:Anything, [44]:Anything, [45]:Anything, [46]:Anything, [47]:Anything, [48]:Pointer, [48,0]:Pointer, [48,8]:Float@float, [48,12]:Anything, [48,13]:Anything, [48,14]:Anything, [48,15]:Anything, [48,16]:Float@double}"
