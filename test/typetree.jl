...
@testset "TypeTree" begin
    ...
    if Sys.WORD_SIZE == 64
        @test tt(UnionMember) == "{[0]:Float@float, [4]:Integer, [5]:Integer, [6]:Integer, [7]:Integer, [8]:Pointer, [16]:Integer, [17]:Integer, [18]:Integer, [19]:Integer, [20]:Integer, [21]:Integer, [22]:Integer, [23]:Integer}"
        ...
        @test tt(Sibling2{Sibling2{LList2{Tuple{Float32,Float64}}}}) ==
              "{[0]:Pointer, [0,0]:Pointer, [0,8]:Float@float, [0,12]:Integer, [0,13]:Integer, [0,14]:Integer, [0,15]:Integer, [0,16]:Float@double, [8]:Integer, [9]:Integer, [10]:Integer, [11]:Integer, [12]:Integer, [13]:Integer, [14]:Integer, [15]:Integer, [16]:Pointer, [16,0]:Pointer, [16,8]:Float@float, [16,12]:Integer, [16,13]:Integer, [16,14]:Integer, [16,15]:Integer, [16,16]:Float@double, [24]:Integer, [25]:Integer, [26]:Integer, [27]:Integer, [28]:Integer, [29]:Integer, [30]:Integer, [31]:Integer, [32]:Pointer, [32,0]:Pointer, [32,8]:Float@float, [32,12]:Integer, [32,13]:Integer, [32,14]:Integer, [32,15]:Integer, [32,16]:Float@double, [40]:Integer, [41]:Integer, [42]:Integer, [43]:Integer, [44]:Integer, [45]:Integer, [46]:Integer, [47]:Integer, [48]:Pointer, [48,0]:Pointer, [48,8]:Float@float, [48,12]:Integer, [48,13]:Integer, [48,14]:Integer, [48,15]:Integer, [48,16]:Float@double}"
    ...
    @test tt(UnionStruct1{Float32}) == "{[0]:Float@float, [4]:Integer, [5]:Integer, [6]:Integer, [7]:Integer, [8]:Pointer}"

    if Sys.WORD_SIZE == 64
        @test tt(UnionStruct1{Float64}) == "{[0]:Float@double, [8]:Integer, [9]:Integer, [10]:Integer, [11]:Integer, [12]:Integer, [13]:Integer, [14]:Integer, [15]:Integer, [16]:Pointer}"
    else
        @test tt(UnionStruct1{Float64}) == "{[0]:Float@double, [8]:Integer, [9]:Integer, [10]:Integer, [11]:Integer, [12]:Pointer}"
    end
end
